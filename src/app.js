...
const varstaBtn = document.getElementById('varsta-filter-btn');
const varstaDiv = document.querySelector('.varsta-btn');

varstaBtn.addEventListener('click', showVarsta);
function showVarsta() {
	varstaDiv.classList.toggle('display-none')
}
